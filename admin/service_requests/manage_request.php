...
if(isset($_GET['id'])){
$qry = $conn->query("SELECT s.*,cc.category,concat(c.firstname,' ',c.middlename) as fullname,c.email,c.contact, c.address FROM `service_requests` s inner join `categories` cc inner join client_list c on s.client_id = c.id where s.id = '{$_GET['id']}' ");
    ...
    <div class="col-12">
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="price" class="control-label">Service Amount</label>
                    <input type="text" name="price" id="price" class="form-control form-control-sm rounded-0" value="<?php echo isset($price) ? $price : "" ?>" >
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
