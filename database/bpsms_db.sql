...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 22, 2023 at 05:25 AM
...
(4, 'kk', 'kkk', 'Female', '', '8667733206', 'ghgh', 'kk@gmail.com', 'c08ac56ae1145566f2ce54cbbea35fa3', 1, 0, '2023-03-22 06:16:31', NULL);
...
(4, 'SS', 'Ad', 'ad@gmail.com', 1, '2023-03-22 06:14:59'),
(5, 'KK', 'kjjkk', 'fggh@gmail.com', 1, '2023-03-22 06:15:23');
...
(8, 'vehicle_type', 'UU'),
(8, 'vehicle_name', 'hh'),
(8, 'vehicle_registration_number', '86536'),
(8, 'vehicle_model', 'fgvhbjn'),
(8, 'service_id', '2'),
(8, 'pickup_address', ''),
(9, 'vehicle_type', 'VV'),
(9, 'vehicle_name', 'fhg'),
(9, 'vehicle_registration_number', 'df'),
(9, 'vehicle_model', 'dhf'),
(9, 'service_id', '3,4,5'),
(9, 'pickup_address', 'dfgfdfg');
...
INSERT INTO `service_list` (`id`, `service`, `description`, `status`, `delete_flag`, `date_created`, `price`) VALUES
(1, 'Change Oil', 'Change Oil', 1, 0, '2021-09-30 14:11:21', 500),
(2, 'Overall Checkup', 'Overall Checkup', 1, 0, '2021-09-30 14:11:38', 1500),
(3, 'Engine Tune up', 'Engine Tune up', 1, 0, '2021-09-30 14:12:03', 1500),
(4, 'Tire Replacement', 'Tire Replacement', 1, 0, '2021-09-30 14:12:24', 1500),
(5, 'Wash', '&lt;p&gt;Wash&lt;br&gt;&lt;/p&gt;', 1, 0, '2023-03-22 09:13:39', 1200);
...
INSERT INTO `service_requests` (`id`, `client_id`, `service_type`, `mechanic_id`, `status`, `date_created`, `price`) VALUES
(8, 4, 'Drop Off', 4, 3, '2023-03-22 06:17:03', 0),
(9, 4, 'Pick Up', 5, 1, '2023-03-22 09:29:48', 3000);
...
(14, 'cover', 'uploads/1678841880_img3.jpeg');
...
(7, 'jas', 'jas', 'jas', 'c70903749ed556d98a4966fdfb9ccd04', 'uploads/1678844820_img3.jpeg', NULL, 2, '2023-03-15 07:17:34', NULL);
